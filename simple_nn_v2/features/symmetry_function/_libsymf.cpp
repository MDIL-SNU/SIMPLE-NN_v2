...
{
  return _cffi_init("simple_nn_v2.features.symmetry_function._libsymf", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
init_libsymf(void)
{
  _cffi_init("simple_nn_v2.features.symmetry_function._libsymf", 0x2601, &_cffi_type_context);
}
#endif
